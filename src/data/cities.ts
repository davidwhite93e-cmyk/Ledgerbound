import { GoodId, GOODS } from "./goods.js";
...
export interface City {
  ...
  climate: string;
  crime: string;
  priceMultiplier: Partial<Record<GoodId, number>>;
}

const GOODS_BASE_LOOKUP: Record<GoodId, number> = GOODS.reduce((acc, g) => {
...
export function priceAt(cityId: string, goodId: GoodId): number {
