...
export type EncounterKind = "combat" | "inspection" | "peaceful";
...
export const ENCOUNTERS: EncounterDef[] = [
  {
    ...
    description:
      "A ragged band steps out from the tree line, blades already drawn. \"Toll's due, friend -- or we take it the hard way.\"",
    kind: "combat",
  ...
  },
  {
    ...
    description:
      "A Concord patrol flags your wagon down for inspection. If you're carrying Moonleaf, they'll notice.",
    kind: "inspection",
  ...
  },
  {
    ...
    description:
      "A fellow trader hails you on the road, keen to swap notes on prices a few towns over.",
    kind: "peaceful",
