...
export function resolveEncounter(state, encounter, choice) {
    let leveledUp = false;
    if (encounter.kind === "combat") {
        ...
        if (playerPower >= enemyPower) {
            ...
            return {
                message: `You fought them off and claimed ${reward} gold from the wreckage.${leveledUp ? " You feel stronger for it." : ""}`,
                leveledUp,
            };
        }
        else {
...
//# sourceMappingURL=encounterResolution.js.map